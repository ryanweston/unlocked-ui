export default {
  menu: {
    ...
    mobileMenuItem: {
      ...
      default: 'text-text hover:bg-gray-700 hover:text-textContrast',
      active: 'bg-gray-900 text-textContrast',
    },
    menuButton: {
      container: 'absolute inset-y-0 left-0 flex items-center sm:hidden',
      button: 'inline-flex items-center justify-center p-2 rounded-md text-text hover:text-textContrast hover:bg-black focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white',
      icon: 'block h-6 w-6',
      closeIcon: 'text-text',
    },
    logo: {
